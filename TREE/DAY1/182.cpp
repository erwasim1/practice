...
Average rating 4.62/5. Vote count: 375

 Binary Tree, Stack
 Algorithm, Depth-first search, LIFO, Medium, Must Know, Recursive
Previous:Preorder Tree Traversal – Iterative and RecursiveNext:Find the Lowest Common Ancestor (LCA) of two nodes in a binary tree
